<div class="footer">
                    ...
                    <ul class="footer__list">
                        <li class="footer__item">
                            <span class="footer__text">
                                    <i class="fas fa-map-marked-alt"></i> 84 Nguyễn Bá Tuyển, Phường 12, Quận Tân Bình, Tp.HCM
                                </span>
                        </li>
                        <li class="footer__item">
                            <a href="#" class="footer__link">
                                <i class="fas fa-phone"></i> 0777.540.418
                            </a>
                        </li>
                        <li class="footer__item">
                            <a href="#" class="footer__link">
                                <i class="fas fa-envelope"></i> Loidinh174@gmail.com
                            </a>
                        </li>
                        <li class="footer__item">
        ...
        <div class="copyright">
            <span class="footer__text"> &copy Bản quyền thuộc về <a class="footer__link" href="#">YT</a></span>
        </div>
    </div>